...
var Integration = (function () {
    ...
    var _client      = 'General';
    var _validationMode = 'PRE_SEND';
    var _inputSource = 'HTML Folder';
    var _emailMetadata = null;
    ...
    function init(auditData) {
        ...
        _validationMode = auditData.validationMode || 'PRE_SEND';
        _inputSource = auditData.inputSource || 'HTML Folder';
        _emailMetadata = auditData.emailMetadata || null;
    ...
    function _renderExecutionSummary(auditData) {
        ...
        bar.innerHTML =
            ...
            _esbCard(_validationMode, 'Mode',    'var(--text-primary)',   '&#128203;') +
            _esbCard(_inputSource,    'Input',   'var(--text-primary)',   '&#128229;') +
