...
var Categories = (function () {
    ...
    var ALL_CATEGORIES = [
        ...
        },
        {
            ...
            icon:        "✉",
            badgeId:     "badge-EMAIL_METADATA",
            description: "Shows inbox metadata captured from the post-send email selected for validation.",
            recommendation: "Confirm the sent email metadata matches the intended campaign audience and sender details."
        },
        {
            key:         "LINK_VALIDATION",
